...
module MEM_WB (
    ...
    input wire [31:0] mem_wr_data_in,
    ...
    input wire [3:0] write_byte_enable_in,
    ...
    output reg [31:0] mem_wr_data_out,
    ...
    output reg [3:0] write_byte_enable_out,
    ...
    always @(posedge clk or posedge rst) begin
        if (rst) begin
            ...
            write_byte_enable_out <= write_byte_enable_in;
